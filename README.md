...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/docker.md](https://github.com/meeymirita/lab-fixes/blob/main/docker.md) репозитория `lab-fixes`.
